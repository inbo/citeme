...
``` r
ask_language(languages, prompt = "Which language?")
```
...
- languages:
  ...
  A character vector containing the available languages.

- prompt:

  the string printed when prompting the user for input. Should usually
  end with a space `" "`.
