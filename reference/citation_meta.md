...
- `get_person`:
  ...
  Return the individuals and organisations as a list of `person`
  objects.
...
- [`citation_meta$new()`](#method-citation_meta-initialize)
...
- `path`:
  ...
  The path to the root of the project or the file from which to extract
  citation metadata.
