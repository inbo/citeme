...
- [`ask_keywords()`](https://inbo.github.io/citeme/reference/ask_keywords.md)
  ...
  keywords separated by `;`. It will continue to prompt the user until
  at least one keyword is provided. The function returns a character
  vector of the entered keywords, with leading and trailing whitespace
  removed.
...
- [`validate_license_list()`](https://inbo.github.io/citeme/reference/validate_license_list.md)
